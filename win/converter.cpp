...
static codepoint_t decode_utf16(utf16_t const* utf16, int len, int* index)
{
...
static int encode_utf8(codepoint_t codepoint, utf8_t* utf8, int len, int index)
{
...
int utf16_to_utf8(utf16_t const* utf16, int utf16_len, utf8_t* utf8, int utf8_len)
{
	// The next codepoint that will be written in the UTF-8 string
	// or the size of the required buffer if utf8 is NULL
	int utf8_index = 0;

	for (int utf16_index = 0; utf16_index < utf16_len; utf16_index++)
	{
...
static codepoint_t decode_utf8(utf8_t const* utf8, int len, int* index)
{
...
//
// return: The number of characters written to the string.
static int encode_utf16(codepoint_t codepoint, utf16_t* utf16, int len, int index)
{
...
int utf8_to_utf16(utf8_t const* utf8, int utf8_len, utf16_t* utf16, int utf16_len)
{
	// The next codepoint that will be written in the UTF-16 string
	// or the size of the required buffer if utf16 is NULL
	int utf16_index = 0;

	for (int utf8_index = 0; utf8_index < utf8_len; utf8_index++)
	{
